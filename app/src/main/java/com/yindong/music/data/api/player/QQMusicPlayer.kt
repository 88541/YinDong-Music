...
/**
 * QQ音乐播放API（TuneHub V3方式）
 */
object QQMusicPlayer {

    private const val TAG = "QQMusicPlayer"
     ...
     * @return 播放链接结果
     */
    suspend fun getMusicUrl(songmid: String, type: String): MusicUrlResult {
        return withContext(Dispatchers.IO) {
            try {
                Log.d(TAG, "获取QQ音乐播放链接: songmid=$songmid, type=$type")
